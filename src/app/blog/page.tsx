...
import ManInOffice from "../../images/man-in-office.png";
        ...
        <div>
          ...
          <div className=" mt-16">
            <ReactPaginate
              ...
              previousLinkClassName=" text-black font-bold text-2xl mr-4 select-none"
              nextLinkClassName=" text-black font-bold text-2xl ml-4 select-none"
              disabledLinkClassName=" text-medium_grey text-xl select-none"
