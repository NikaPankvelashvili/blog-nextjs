export default function page() {
  return (
    <section>
      <div className="py-20 w-full text-center bg-lavender mb-32">
        <h1 className=" text-black font-bold text-5xl mb-4">Privacy Policy</h1>
        <h5 className=" text-medium_grey">Last Updated on 7th July 2023</h5>
      </div>
      <div className=" flex justify-center mb-32">
        <div className=" w-2/3">
          <h2 className=" text-black font-bold text-5xl mb-8">
            Lorem ipsum dolor sit amet
          </h2>
          <p className=" text-dark_grey mb-8">
          ...
          <h3 className="text-black font-bold text-4xl mb-6">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor.
          </h3>
          <p className=" text-dark_grey mb-8">
            ...
            neque vitae tempus quam. Lorem ipsum dolor sit amet, consectetur
            adipiscing elit, sed do eiusmod tempor incididunt ut labore et
            dolore magna aliqua. Non blandit massa enim nec. Scelerisque viverra
